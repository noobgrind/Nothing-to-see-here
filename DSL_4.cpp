/*
	...
	Roll no - 25
	Problem Statement -
		Construct an Expression Tree from the given prefix expression : +--A*BC/DEF
		and Traverse it using postorder traversal without Recursion and Delete the entire Tree.  
*/
...
5.Post-Order Without Recursion
6.Delete the entire Tree
7.Exit
Enter Your Choice : 1
Enter an Prefix Expression : +--A*BC/DEF
...
7.Exit
Enter Your Choice : 5
Postfix Without Recursion : A B C * - D E / - F + 
